...
{
	// Load an image
	src = imread("C:/Users/sehye/source/repos/Image/testImage/Finger_print_gray.tif", IMREAD_COLOR);
	...
	createTrackbar(trackbar_morph, window_name, &morphology_type, 8, Morphology_Demo);
