...
//
//	// TrackBar 설정
//	namedWindow("MyVideo", 0);
//	setMouseCallback("MyVideo", onMouse, 0);
//	createTrackbar("Hmin", "MyVideo", &hmin, 179, 0);
//	createTrackbar("Hmax", "MyVideo", &hmax, 179, 0);
//	createTrackbar("Smin", "MyVideo", &smin, 255, 0);
//	createTrackbar("Smax", "MyVideo", &smax, 255, 0);
//	createTrackbar("Vmin", "MyVideo", &vmin, 255, 0);
//	createTrackbar("Vmax", "MyVideo", &vmax, 255, 0);
//
//
//	while (true)
//	{
...
//			hmin = MAX((means[0] - stddev[0]), 0);
//			hmax = MIN((means[0] + stddev[0]), 179);
//			setTrackbarPos("Hmin", "MyVideo", hmin);
//			setTrackbarPos("Hmax", "MyVideo", hmax);
//
//			/******** Repeat for S and V trackbar ********/
//			hmin = MAX((means[0] - stddev[0]), 0);
//			hmax = MIN((means[0] + stddev[0]), 179);
...
//			smin = MAX((means[1] - stddev[1]), 0);
//			smax = MIN((means[1] + stddev[1]), 255);
//			setTrackbarPos("smin", "MyVideo", smin);
//			setTrackbarPos("smax", "MyVideo", smax);
//
//			vmin = MAX((means[2] - stddev[2]), 0);
//			vmax = MIN((means[2] + stddev[2]), 255);
//			setTrackbarPos("vmin", "MyVideo", vmin);
//			setTrackbarPos("vmax", "MyVideo", vmax);
//		}
//
//
//		if (selectObject && selection.area() > 0)  // Left Mouse is being clicked and dragged
